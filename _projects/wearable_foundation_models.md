...
In our paper _LSM-2: Learning from Incomplete Wearable Sensor Data_ {% cite xu2025lsm %}, submitted to NeurIPS'25, we introduce AIM (adaptive and inherited masking), a means of cleverly leveraging masked-pretraining and the encoder's attention mask to ignore missing segments of data.
